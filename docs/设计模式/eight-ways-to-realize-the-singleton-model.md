...
## <span style="color:orange">一、饿汉式（静态变量）</span>
...
## <span style="color:orange">二、饿汉式（静态代码块）</span>
...
## <span style="color:green">六、懒汉式(双重检查锁)</span>
...
## <span style="color:orange">七、懒汉式(静态内部类)</span>
...
## <span style="color:green">八、懒汉式(枚举类)</span>
