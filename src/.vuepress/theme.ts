...
export default hopeTheme({
  ...
  blog: {
    medias: {
      ...
      Weibo: "https://weibo.com/520yych", // 手机网页登录微博可以看到个性域名(微博地址)
    },
  },
  ...
  plugins: {
    ...
    pwa: {
      ...
      appendBase: true,
      apple: {
        icon: "/assets/icon/bitbug_favicon144.png",
        statusBarColor: "black",
      },
      msTile: {
        image: "/assets/icon/bitbug_favicon144.png",
        color: "#ffffff",
      },
      manifest: {
        icons: [
          {
            src: "/assets/icon/bitbug_favicon144.png",
            sizes: "144x144",
            purpose: "maskable",
            type: "image/png",
          },
